import { ActionIcon, Badge, Group, Text, Modal, ScrollArea, Code, Loader, Alert } from "@mantine/core";
import { IconEdit, IconReportSearch, IconTrash, IconRefresh } from "@tabler/icons-react";
		...
		try {
			...
			if (response.data.status === "ok") {
				...
				Swal.fire({
					icon: "error",
					title: "Error",
					text: response.data.messages || "Failed to load ISP pricing data",
				});
			}
		} catch (error) {
			console.error(error);
